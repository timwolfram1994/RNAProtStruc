            ...
            while D.nodes[edge[0]]['pebbles'] + D.nodes[edge[1]]['pebbles'] < l+1:
                ...
                for idx, _edge in enumerate(dfslist_u):  # u of edge is starting node
                    ...
                    if D.nodes[_edge[1]]['pebbles'] > 0:  # first edge is (u, u+1)
                        ...
                        for __edge in dfslist_u[0:idx+1]:  # reverse the directions of the edges !!! hier berichtigen: tiefensuche könnte auch Knoten enthalten die außerhalb des direkten Pfades liegen
                ...
                compare2 = D.nodes[edge[0]]['pebbles'] + D.nodes[edge[1]]['pebbles'] #break out of while loop if pebbles didn't change
...
if __name__ == '__main__':
    ...
    G_a.add_edges_from([(1,2),(1,3),(1,3),(1,4),(1,5),(1,5),(2,4),(2,4),(3,4),(3,4),(3,4),(3,5),(3,6),(3,6),(3,6)])
